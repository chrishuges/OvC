...
###############################################################################
#this will give normalized human peptides
###############################################################################
...
saveRDS(a1n,'ch_OvC_wStd_normalizedPeptides_Human_fa1.rds')
saveRDS(a2n,'ch_OvC_wStd_normalizedPeptides_Human_fa2.rds')
saveRDS(a3n,'ch_OvC_wStd_normalizedPeptides_Human_fa3.rds')
saveRDS(b1n,'ch_OvC_wStd_normalizedPeptides_Human_fb1.rds')
saveRDS(b2n,'ch_OvC_wStd_normalizedPeptides_Human_fb2.rds')
saveRDS(b3n,'ch_OvC_wStd_normalizedPeptides_Human_fb3.rds')

###############################################################################
#this will give normalized EColi peptides
###############################################################################
#use this function for normalization
pepNorm = function(x,...){
	#mark the spike-in control peptides
	...
	#recombine the replicates
	vnormFull = as.data.frame(cbind(x[spikeins,c(1:6,17)],nkid.h))
	#output the data
	return(vnormFull)
}
#apply the function
...
#output the data objects
saveRDS(a1e,'ch_OvC_wStd_normalizedPeptides_EColi_fa1.rds')
saveRDS(a2e,'ch_OvC_wStd_normalizedPeptides_EColi_fa2.rds')
saveRDS(a3e,'ch_OvC_wStd_normalizedPeptides_EColi_fa3.rds')
saveRDS(b1e,'ch_OvC_wStd_normalizedPeptides_EColi_fb1.rds')
saveRDS(b2e,'ch_OvC_wStd_normalizedPeptides_EColi_fb2.rds')
saveRDS(b3e,'ch_OvC_wStd_normalizedPeptides_EColi_fb3.rds')
