...
saveRDS(pecP,'ch_OvC_CellLine_proteinSet.rds')
write.table(pecP,'ch_OvC_CellLine_HGSvCCC_PECA_proteinSet.txt',quote=FALSE,sep='\t',col.names=TRUE,row.names=FALSE)
...
proh = readRDS('ch_OvC_CellLine_proteinSet.rds')
...
pdf('ch_OvC_TMT10_CellLine_Human_Proteins_HGSvCCC_Volcano.pdf')
...
text(4,2.3,paste('p<0.05'),cex=1.25)
text(proh.s$logFC, -log10(proh.s$score), proh.s$Gene, cex=0.5)
dev.off()
